    ...
    return useQuery({
        ...
        select: (data): APIKeyStatsResponseFormatted => ({
            stats: {
                ...
                probe_input_token: formatCount(data.stats.probe_input_token),
                probe_output_token: formatCount(data.stats.probe_output_token),
                probe_total_token: formatCount(data.stats.probe_input_token + data.stats.probe_output_token),
                probe_count: formatCount(data.stats.probe_count),
                ...
                probe_cost: formatMoney(data.stats.probe_cost),
