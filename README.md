...
本 Fork 基于 [bestruirui/octopus](https://github.com/bestruirui/octopus)，主要修改内容：

**功能增强：**

**v0.3.4：**
- 🔒 **敏感信息过滤** - 自动过滤API请求中的敏感信息（API Key、密码、Token等）
- 🎛️ **可配置过滤规则** - 支持自定义正则表达式过滤规则
- 📊 **内置规则库** - 预设常见敏感信息过滤规则（OpenAI/Anthropic API Key、数据库URL、JWT Token等）
- 🏠 **仓库地址更新** - 更新为 `huise23/octopus`，从本项目检查更新

**v0.2.6：**
- 📋 **批量选择��型** - 支持复选框多选，Shift+点击范围选择
